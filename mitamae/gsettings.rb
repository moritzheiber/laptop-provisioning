...

{
  ...
  'org.gnome.settings-daemon.plugins.media-keys.custom-keybindings.custom0 binding': '<Primary><Alt>Delete',
  'org.gnome.settings-daemon.plugins.media-keys.custom-keybindings.custom0 command': 'systemctl suspend',
  'org.gnome.settings-daemon.plugins.media-keys.custom-keybindings.custom0 name': 'Suspend',
